...
async function buscarEnDbReservaEnSemanaLs(semana) {
  ...
  try {
    ...
    r.provincia as provincia_envio_domicilio_diploma,
    r.localidad as localidad_envio_domicilio_diploma,
    r.fecha_reserva as fecha_reserva,
    r.fecha_venta as fecha_venta,
    r.nro_ref_pago as nro_ref_pago,
    r.monto_abonado as monto_abonado,
