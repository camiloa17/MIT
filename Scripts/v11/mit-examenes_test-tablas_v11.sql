INSERT INTO `materia` (`uuid`, `nombre`, `activo`, `mostrar_cliente`, `edita_user_secundario`)
VALUES 
( UUID_TO_BIN('7617fbca-bc90-443e-ace0-8806b8b3eeb3'), "Inglés", true, true, false),
( UUID_TO_BIN('3efa3397-b1f1-4465-8e65-321a2df57aa0'), "Instrumentos",true, true, false),
( UUID_TO_BIN('bbe40d66-1cad-435c-89a3-4eeaf1edea1c'), "Danza", true, true, false),
( UUID_TO_BIN('3c93d1b4-6b96-4af6-8353-423946198f6f'), "Teatro", true, true, false);

INSERT INTO `tipo` (`uuid`, `materia_uuid`, `nombre`, `activo`, `mostrar_cliente`, `edita_user_secundario`)
VALUES 
(UUID_TO_BIN('1c75e7d9-0bc2-4322-8b57-173d353afb6b'), UUID_TO_BIN('7617fbca-bc90-443e-ace0-8806b8b3eeb3'), "ISE", true, true, false),
(UUID_TO_BIN('bdb9667b-ea23-4cfe-b6c3-60a68b32615c'), UUID_TO_BIN('7617fbca-bc90-443e-ace0-8806b8b3eeb3'), "GESE", true, true, false),
(UUID_TO_BIN('34b05f00-f620-49eb-9e11-f790f508f21b'), UUID_TO_BIN('3efa3397-b1f1-4465-8e65-321a2df57aa0'), "Guitarra", true, true, false),
(UUID_TO_BIN('42631e47-10b9-44cc-bff3-932497f22692'), UUID_TO_BIN('3efa3397-b1f1-4465-8e65-321a2df57aa0'), "Piano", true, true, false);
