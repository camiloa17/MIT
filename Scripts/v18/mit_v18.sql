...
CREATE TABLE IF NOT EXISTS `mit`.`reserva` (
  ...
  `transaccion_id` VARCHAR(40) NULL,
  `transaccion_status` VARCHAR(30) NULL,
  `monto` INT(8) NULL,
  ...
  `localidad_envio_domicilio` VARCHAR(45) NULL,
  `provincia_envio_domicilio` VARCHAR(45) NULL,
